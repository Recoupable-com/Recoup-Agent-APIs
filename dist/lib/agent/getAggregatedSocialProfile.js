...
const getAggregatedSocialProfile = (funnelAnalyses, existingArtist) => {
    const { name, nickname, region, avatar, bio, followers, followings } = funnelAnalyses.reduce((acc, fa) => {
...
exports.default = getAggregatedSocialProfile;
