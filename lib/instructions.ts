export const instructions = {
  ...
  sort_fans_on_segments:
    "Analyze the provided comment data to determine the segment each user belongs to as reflected in the comment data. User name is included in the comments data, and by analyzing the user's comments, you can determine the segment each user belongs to. Please analyze at least 100 users reflected in the comments. The results are displayed as a list of user names and their corresponding segment names in the following format: { [UserName]: [SegmentName] }.",
  get_fan_segments:
